      ...
      <div className="hidden lg:flex relative bg-black">
        ...
        <div className="relative z-10 p-10 flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="mt-4 text-white/70 text-sm max-w-md leading-relaxed">
              Every great player started with a single opportunity. ScoutX makes sure yours doesn't get lost in the noise — with verified profiles, standardized fitness data, and direct access to the clubs that matter.
            </div>
          </div>
        </div>
      </div>
